...
@note: this code derived from 
- PybioMed<https://github.com/gadsbyfly/PyBioMed> and 
- https://github.com/shenwanxiang/bidd-molmap/blob/master/molmap/feature/descriptor/charge.py,
...
def gen_charge_desc(mol):
    ...
    for DesLabel in _Charge.keys():
        ...
        if abs(res) == numpy.inf:
            res = numpy.nan
        result[DesLabel]=res
    return numpy.array(list(result.values()), dtype=numpy.float16)
